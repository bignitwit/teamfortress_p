...
const char *g_aWeaponNames[] =
{
	...
	"TF_WEPON_FLAME_BALL",
	"TF_WEAPON_MINIGUN_ARTILLERY",
	"TF_WEAPON_SHOTGUN_REVENGE_SECONDARY"
};
...
int g_aWeaponDamageTypes[] =
{
	...
	DMG_BULLET | DMG_USEDISTANCEMOD,		// TF_WEAPON_MINIGUN_ARTILLERY,
	DMG_BUCKSHOT | DMG_USEDISTANCEMOD, // TF_WEAPON_SHOTGUN_REVENGE
