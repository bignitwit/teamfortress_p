...
CREATE_SIMPLE_WEAPON_TABLE(TFShotgun_Revenge_Secondary, tf_weapon_shotgun_revenge_secondary)
...
{
	int iShotgunDoubleShot = 0;
	CALL_ATTRIB_HOOK_INT(iShotgunDoubleShot, shotgun_doubleshot);

	if (iShotgunDoubleShot == 0)
		return;
