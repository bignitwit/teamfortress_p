...
public:
	...
	CEconItemView* AddAutoUnlockItem(int id);
	...
	int                 GetAutoUnlockItemCount() { return m_pAutoUnlockLoadoutItems.Count(); }
	CEconItemView* GetAutoUnlockItem(int iIndex) { return m_pAutoUnlockLoadoutItems[iIndex]; }
...
private:
	...
	CUtlVector<CEconItemView*>	m_pAutoUnlockLoadoutItems;
